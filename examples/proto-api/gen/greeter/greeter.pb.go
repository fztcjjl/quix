...
const file_greeter_greeter_proto_rawDesc = "" +
	"\n" +
	"\x15greeter/greeter.proto\x12\agreeter\x1a\x1cgoogle/api/annotations.proto\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2[\n" +
	"\aGreeter\x12P\n" +
	"\bSayHello\x12\x15.greeter.HelloRequest\x1a\x16.greeter.HelloResponse\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/hello/{name}B\x97\x01\n" +
	"\vcom.greeterB\fGreeterProtoP\x01Z>github.com/fztcjjl/quix/examples/proto-api/gen/greeter;greeter\xa2\x02\x03GXX\xaa\x02\aGreeter\xca\x02\aGreeter\xe2\x02\x13Greeter\\GPBMetadata\xea\x02\aGreeterb\x06proto3"
